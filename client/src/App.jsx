...
function App() {
  ...
  const fetchBotResponse = async () => {
    const { data } = await axios.post("https://chatgpt-app-mnob.onrender.com", { input }, {
      headers: {
  ...
  // let arr = [
  //   {type: "user", post: "abcdefghij"},
  //   {type: "bot", post: "abcdefghij"}
  // ]
    ...
    <section className="chat-container">
      <div className="layout">
        ...
        {/* <div className="chat-bubble bot">
          ...
          <div className="post">Lorem, ipsum dolor sit amet consectetur.</div>
        </div> */}
      </div>
    </section>
    <footer>
